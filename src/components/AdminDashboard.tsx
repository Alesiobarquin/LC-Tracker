                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-3 flex-1 min-w-0 pl-1">
                      ...
                      {ticket.image_url && (
                        <a href={sanitizeUrl(ticket.image_url)} target="_blank" rel="noopener noreferrer" className="block w-max rounded-xl border border-zinc-700/70 bg-zinc-950/40 p-1 hover:border-zinc-500 transition-colors">
                          <img
                            src={sanitizeUrl(ticket.image_url)}
