        ...
        <div className="premium-card p-4 sm:p-6 border-amber-500/30 bg-amber-500/5 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative z-10">
            ...
            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
              ...
              <button aria-label="Dismiss catch-up message" onClick={dismissCatchUpBanner} className="px-2 py-2 text-zinc-500 hover:text-zinc-300 rounded-lg hover:bg-zinc-800/50 transition-colors focus-visible:ring-2 outline-none focus-visible:ring-amber-500"><X size={18} /></button>
            </div>
          </div>
        </div>
      )}
                        ...
                        <div className="flex gap-2">
                          {isPrimary && (
                            <button
                              ...
                              className="p-2.5 bg-zinc-800/80 hover:bg-amber-500/10 hover:border-amber-500/30 rounded-xl text-zinc-400 hover:text-amber-400 transition-colors border border-zinc-700/50 focus-visible:ring-2 outline-none focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                              title="Skip this problem"
                            >
                              <SkipForward size={18} />
                            </button>
                          )}
                          <a aria-label={`Open ${prob.title} on LeetCode`} href={prob.leetcodeUrl} target="_blank" rel="noreferrer" className="p-2.5 bg-zinc-800/80 hover:bg-zinc-700 rounded-xl text-zinc-300 transition-colors border border-zinc-700/50 hover:border-zinc-600 focus-visible:ring-2 outline-none focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"><ExternalLink size={18} /></a>
                        </div>
                      </div>
                      <button
                  ...
                  return (
                    <div key={prob.id} className="premium-card p-4 flex items-center justify-between group">
                      ...
                      <button
                        ...
                        className="p-2.5 bg-zinc-800/80 hover:bg-amber-500 hover:text-zinc-950 text-zinc-300 rounded-xl transition-all duration-200 border border-zinc-700/50 hover:border-amber-500 focus-visible:ring-2 outline-none focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                      >
