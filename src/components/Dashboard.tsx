...
import { syntaxCardMap } from '../data/syntaxCards';
...
export const Dashboard: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Replacing O(N) array .find() searches with O(1) map lookups.
  // Using pre-computed maps like `problemMap` and `syntaxCardMap` eliminates
  // hidden bottlenecks when resolving arrays of IDs into data objects during render.
