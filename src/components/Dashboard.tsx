        ...
        <div className="premium-card p-4 sm:p-6 border-amber-500/30 bg-amber-500/5 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative z-10">
            ...
            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
              ...
              <button onClick={dismissCatchUpBanner} aria-label="Dismiss catch-up banner" title="Dismiss catch-up banner" className="px-2 py-2 text-zinc-500 hover:text-zinc-300 rounded-lg hover:bg-zinc-800/50 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"><X size={18} /></button>
            </div>
          </div>
        </div>
      )}
                  ...
                  <div className="mt-8 flex flex-col md:flex-row md:items-start gap-6">
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2 mt-4">
                        <a href={newProblemData.leetcodeUrl} target="_blank" rel="noreferrer" aria-label={`Open ${newProblemData.title} on LeetCode`} title={`Open ${newProblemData.title} on LeetCode`} className="p-2.5 bg-zinc-800/80 hover:bg-zinc-700 rounded-xl text-zinc-300 transition-colors border border-zinc-700/50 outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"><ExternalLink size={16} /></a>
                        ...
                        <div className="flex gap-2">
                          {isPrimary && (
                            <button
                              ...
                              className="p-2.5 bg-zinc-800/80 hover:bg-amber-500/10 hover:border-amber-500/30 rounded-xl text-zinc-400 hover:text-amber-400 transition-colors border border-zinc-700/50 outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
                          ...
                          <a href={prob.leetcodeUrl} target="_blank" rel="noreferrer" aria-label={`Open ${prob.title} on LeetCode`} title={`Open ${prob.title} on LeetCode`} className="p-2.5 bg-zinc-800/80 hover:bg-zinc-700 rounded-xl text-zinc-300 transition-colors border border-zinc-700/50 hover:border-zinc-600 outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"><ExternalLink size={18} /></a>
                        </div>
                      </div>
                      <button
              ...
              {sprintDayInfo && (
                <>
                  <div className="flex justify-between items-center text-xs text-zinc-400 mb-1">
                    ...
                    <div className="flex items-center gap-2">
                       <button onClick={() => void updateSprintState({ extensionDays: Math.max(0, (sprintState?.extensionDays ?? 0) - 1) })} className="hover:text-emerald-400 transition-colors px-1 border border-zinc-700 rounded bg-zinc-800 outline-none focus-visible:ring-2 focus-visible:ring-emerald-500" title="Decrease Sprint Length" aria-label="Decrease Sprint Length">-1d</button>
                       <button onClick={() => void updateSprintState({ extensionDays: (sprintState?.extensionDays ?? 0) + 1 })} className="hover:text-emerald-400 transition-colors px-1 border border-zinc-700 rounded bg-zinc-800 outline-none focus-visible:ring-2 focus-visible:ring-emerald-500" title="Increase Sprint Length" aria-label="Increase Sprint Length">+1d</button>
