        ...
        <div className="premium-card p-4 sm:p-6 border-amber-500/30 bg-amber-500/5 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative z-10">
            ...
            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
              ...
              <button onClick={dismissCatchUpBanner} aria-label="Dismiss catch-up banner" className="px-2 py-2 text-zinc-500 hover:text-zinc-300 rounded-lg hover:bg-zinc-800/50 transition-colors focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"><X size={18} /></button>
            </div>
          </div>
        </div>
      )}
