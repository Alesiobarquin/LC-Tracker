...
export const Dashboard: React.FC = () => {
  ...
  // Bolt Optimization: Replaced O(N) allProblems.find() with O(1) problemMap lookup
  const newProblemData = effectiveNewProblemId ? problemMap[effectiveNewProblemId] : null;
  // Bolt Optimization: Replaced O(N) allProblems.find() inside map with O(1) problemMap lookup
  ...
  // Bolt Optimization: Replaced O(N) allSyntaxCards.find() inside map with O(1) syntaxCardMap lookup
