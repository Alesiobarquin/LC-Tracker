        ...
        <div className="premium-card p-4 sm:p-6 border-amber-500/30 bg-amber-500/5 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative z-10">
            ...
            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
              ...
              <button aria-label="Dismiss catch up banner" onClick={dismissCatchUpBanner} className="px-2 py-2 text-zinc-500 hover:text-zinc-300 rounded-lg hover:bg-zinc-800/50 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"><X size={18} /></button>
            </div>
          </div>
        </div>
      )}
                  ...
                  return (
                    <div key={prob.id} className="premium-card p-4 flex items-center justify-between group">
                      ...
                      <button
                        ...
                        className="p-2.5 bg-zinc-800/80 hover:bg-amber-500 hover:text-zinc-950 text-zinc-300 rounded-xl transition-all duration-200 border border-zinc-700/50 hover:border-amber-500 outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
                        aria-label={`Start review session for ${prob.title}`}
                      >
              ...
              {sprintDayInfo && (
                <>
                  <div className="flex justify-between items-center text-xs text-zinc-400 mb-1">
                    ...
                    <div className="flex items-center gap-2">
                       <button aria-label="Decrease Sprint Length" onClick={() => void updateSprintState({ extensionDays: Math.max(0, (sprintState?.extensionDays ?? 0) - 1) })} className="hover:text-emerald-400 transition-colors px-1 border border-zinc-700 rounded bg-zinc-800 outline-none focus-visible:ring-2 focus-visible:ring-emerald-500" title="Decrease Sprint Length">-1d</button>
                       <button aria-label="Increase Sprint Length" onClick={() => void updateSprintState({ extensionDays: (sprintState?.extensionDays ?? 0) + 1 })} className="hover:text-emerald-400 transition-colors px-1 border border-zinc-700 rounded bg-zinc-800 outline-none focus-visible:ring-2 focus-visible:ring-emerald-500" title="Increase Sprint Length">+1d</button>
