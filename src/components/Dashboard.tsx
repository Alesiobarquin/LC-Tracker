...
export const Dashboard: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Use pre-computed O(1) hash maps (problemMap, syntaxCardMap)
  // instead of O(N) allProblems.find() inside render and loops to prevent hidden O(N^2) bottlenecks.
