                ...
                {!confirmAbandon ? (
                    <div className="flex gap-2 mt-1">
                        ...
                        <button
                            ...
                            className="flex items-center justify-center w-8 h-8 bg-zinc-800/70 hover:bg-red-500/15 text-zinc-500 hover:text-red-400 rounded-lg transition-colors border border-zinc-700/50 focus-visible:ring-2 outline-none focus-visible:ring-red-500"
