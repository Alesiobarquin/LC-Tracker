           ...
           <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              >
                ...
                <button 
                  ...
                  title="Close"
                  className="absolute top-4 right-4 p-1 rounded-lg text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800 transition-colors z-20 focus-visible:ring-2 outline-none focus-visible:ring-emerald-500"
                >
                  <X size={20} />
                </button>
