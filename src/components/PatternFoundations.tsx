...
import { problems, allProblems, problemMap, problemTitleToProblemMap } from '../data/problems';
    ...
    return patterns.map(pattern => {
      ...
      const extraMapped = (pattern.educativeProblems || [])
        .map(ep => {
          ...
          // O(1) title lookup using pre-computed map
          return problemTitleToProblemMap[lowerTitle];
        })
