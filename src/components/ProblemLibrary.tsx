                            ...
                            <td className="px-6 py-4 text-right">
                              <div className="inline-flex items-center justify-end gap-2">
                                ...
                                <button
                                  ...
                                  aria-label={isPremium && !settings.includePremiumInAssignments ? `Confirm before starting LeetCode Premium problem: ${prob.title}` : `Start practice timer for ${prob.title}`}
                                >
                                  <Play size={16} />
                                </button>
                              </div>
