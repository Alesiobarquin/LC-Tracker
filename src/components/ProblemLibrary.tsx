                          ...
                          <tr key={prob.id} className="hover:bg-zinc-800/50 transition-colors group" style={virtualRowStyle}>
                            <td className="px-6 py-4">
                              <button 
                                 ...
                                 title={`${statusTitle} for ${prob.title}`}
                            ...
                            <td className="px-6 py-4 text-right">
                              <div className="inline-flex items-center justify-end gap-2">
                                ...
                                <button
                                  ...
                                  title={isPremium && !settings.includePremiumInAssignments ? `LeetCode Premium: confirm before starting ${prob.title}` : `Start practice timer for ${prob.title}`}
                                  aria-label={isPremium && !settings.includePremiumInAssignments ? `LeetCode Premium: confirm before starting ${prob.title}` : `Start practice timer for ${prob.title}`}
                                >
                                  <Play size={16} />
                                </button>
                              </div>
