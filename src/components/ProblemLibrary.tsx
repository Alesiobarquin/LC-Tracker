                          ...
                          <tr key={prob.id} className="hover:bg-zinc-800/50 transition-colors group" style={virtualRowStyle}>
                            <td className="px-6 py-4">
                              <button 
                                 ...
                                 className="focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none hover:scale-110 transition-transform active:scale-95"
                                 title={statusTitle}
                            ...
                            <td className="px-6 py-4 text-right">
                              <div className="inline-flex items-center justify-end gap-2">
                                ...
                                <button
                                  ...
                                  className="p-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-100 rounded-lg transition-colors opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
