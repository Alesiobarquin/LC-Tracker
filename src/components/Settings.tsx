                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        aria-label="Sync LeetCode profile manually"
                                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="pt-4 border-t border-zinc-800/50">
                                ...
                                <div className="flex gap-2 mb-3">
                                    ...
                                    <button onClick={handleAddBlackoutDate} disabled={!newBlackoutStart || !newBlackoutEnd} className="p-2 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 text-zinc-300 rounded-xl transition-colors shrink-0" aria-label="Add blackout date">
                                        <Plus size={20} />
                                    </button>
                                </div>
                                <div className="space-y-2">
                                    {settings.studySchedule.blackoutDates.map((date, idx) => (
                                        <div key={idx} className="flex justify-between items-center bg-zinc-900 border border-zinc-800/50 p-2 rounded-lg text-sm text-zinc-300">
                                            ...
                                            <button onClick={() => handleRemoveBlackoutDate(idx)} className="text-red-400 hover:bg-red-500/10 p-1 rounded-md transition-colors" aria-label="Remove blackout date"><X size={14} /></button>
                                        </div>
                                    ))}
                    ...
                    <section className="premium-card p-6 border-emerald-500/20">
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                />
                                <button type="button" onClick={handleAddEvent} disabled={!newEventTitle || !newEventDate} className="p-2 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 text-zinc-300 rounded-xl transition-colors shrink-0 flex justify-center items-center" aria-label="Add target event">
                                    <Plus size={20} />
                                </button>
                            </div>
                            ...
                            <div className="space-y-2 mt-4">
                                {targetEvents.map((event) => (
                                    <div key={event.id} className="flex justify-between items-center bg-zinc-900 border border-zinc-800/50 p-3 rounded-lg">
                                        ...
                                        <button onClick={() => removeTargetEvent(event.id)} className="text-red-400 hover:bg-red-500/10 p-2 rounded-lg transition-colors" aria-label="Remove target event"><X size={16} /></button>
                                    </div>
                                ))}
