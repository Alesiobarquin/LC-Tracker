                            ...
                            <div className="pt-4 border-t border-zinc-800/50">
                                ...
                                <div className="flex gap-2 mb-3">
                                    ...
                                    <button
                                        ...
                                        title={(!newBlackoutStart || !newBlackoutEnd) ? "Select both start and end dates to add" : "Add blackout date"}
                                        onClick={handleAddBlackoutDate}
                                        disabled={!newBlackoutStart || !newBlackoutEnd}
                                        className="p-2 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 text-zinc-300 rounded-xl transition-colors shrink-0 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                                    >
                                        <Plus size={20} />
                                    </button>
                                </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                <button
                                    ...
                                    title={(!newEventTitle || !newEventDate) ? "Enter title and select date to add" : "Add target event"}
                                    onClick={handleAddEvent}
                                    disabled={!newEventTitle || !newEventDate}
                                    className="p-2 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 text-zinc-300 rounded-xl transition-colors shrink-0 flex justify-center items-center focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                                >
                                    <Plus size={20} />
                                </button>
                            </div>
