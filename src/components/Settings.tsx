                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        aria-label="Sync LeetCode progress manually"
                                        title="Sync LeetCode progress manually"
                                        className="px-4 py-3 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 rounded-xl text-zinc-300 transition-colors flex items-center justify-center shrink-0 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="pt-4 border-t border-zinc-800/50">
                                ...
                                <div className="flex gap-2 mb-3">
                                    ...
                                    <button aria-label="Add blackout date" title="Add blackout date" onClick={handleAddBlackoutDate} disabled={!newBlackoutStart || !newBlackoutEnd} className="p-2 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 text-zinc-300 rounded-xl transition-colors shrink-0 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none">
                                        <Plus size={20} />
                                    </button>
                                </div>
                                <div className="space-y-2">
                                    {settings.studySchedule.blackoutDates.map((date, idx) => (
                                        <div key={idx} className="flex justify-between items-center bg-zinc-900 border border-zinc-800/50 p-2 rounded-lg text-sm text-zinc-300">
                                            ...
                                            <button aria-label={`Remove blackout date from ${new Date(date.start).toLocaleDateString()} to ${new Date(date.end).toLocaleDateString()}`} title="Remove blackout date" onClick={() => handleRemoveBlackoutDate(idx)} className="text-red-400 hover:bg-red-500/10 p-1 rounded-md transition-colors focus-visible:ring-2 focus-visible:ring-red-500 outline-none"><X size={14} /></button>
                                        </div>
                                    ))}
                    ...
                    <section className="premium-card p-6 border-emerald-500/20">
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                />
                                <button aria-label="Add target event" title="Add target event" type="button" onClick={handleAddEvent} disabled={!newEventTitle || !newEventDate} className="p-2 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 text-zinc-300 rounded-xl transition-colors shrink-0 flex justify-center items-center focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none">
                                    <Plus size={20} />
                                </button>
                            </div>
                            ...
                            <div className="space-y-2 mt-4">
                                {targetEvents.map((event) => (
                                    <div key={event.id} className="flex justify-between items-center bg-zinc-900 border border-zinc-800/50 p-3 rounded-lg">
                                        ...
                                        <button aria-label={`Remove target event: ${event.title}`} title="Remove target event" onClick={() => removeTargetEvent(event.id)} className="text-red-400 hover:bg-red-500/10 p-2 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-red-500 outline-none"><X size={16} /></button>
                                    </div>
                                ))}
