                                ...
                                <div className="space-y-2">
                                    {settings.studySchedule.blackoutDates.map((date, idx) => (
                                        <div key={idx} className="flex justify-between items-center bg-zinc-900 border border-zinc-800/50 p-2 rounded-lg text-sm text-zinc-300">
                                            ...
                                            <button aria-label="Remove blackout date" onClick={() => handleRemoveBlackoutDate(idx)} className="text-red-400 hover:bg-red-500/10 p-1 rounded-md transition-colors focus-visible:ring-2 focus-visible:ring-red-500 outline-none"><X size={14} /></button>
                                        </div>
                                    ))}
                            ...
                            <div className="space-y-2 mt-4">
                                {targetEvents.map((event) => (
                                    <div key={event.id} className="flex justify-between items-center bg-zinc-900 border border-zinc-800/50 p-3 rounded-lg">
                                        ...
                                        <button aria-label="Remove target event" onClick={() => removeTargetEvent(event.id)} className="text-red-400 hover:bg-red-500/10 p-2 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-red-500 outline-none"><X size={16} /></button>
                                    </div>
                                ))}
