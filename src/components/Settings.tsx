                    ...
                    <section className="premium-card p-6 border-emerald-500/20">
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                />
                                <button aria-label="Add event" type="button" onClick={handleAddEvent} disabled={!newEventTitle || !newEventDate} className="p-2 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 text-zinc-300 rounded-xl transition-colors shrink-0 flex justify-center items-center focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none">
                                    <Plus size={20} />
                                </button>
                            </div>
